...
from .utils.json_encoder import ucarballJsonEncoder
...
class AnalysisManager:
    ...
    def write_json_out_to_file(self, file: IO):
        ...
        json.dump(js, file, indent=2, cls=ucarballJsonEncoder)
    ...
    def get_protobuf_data(self) -> game_pb2.Game:
        ...
        files found at https://github.com/SaltieRL/ucarball/tree/master/api.
    ...
    def get_json_data(self):
        ...
        The json fields are defined by https://github.com/SaltieRL/ucarball/tree/master/api
        """
        printer = _Printer()
        js = printer._MessageToJsonObject(self.protobuf_game)
        return js
