...
from ucarball.extras.per_goal_analysis import PerGoalAnalysis
...
def analyze_replay_file(replay_path: str, controls: ControlsCreator = None,
    ...
    :param logging_level: Sets the logging level globally across ucarball
    ...
    if logging_level != logging.NOTSET:
        logging.getLogger('ucarball').setLevel(logging_level)
...
if __name__ == '__main__':
    from ucarball.tests.analysis_test import __test_replays
